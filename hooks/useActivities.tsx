...
import { IActivity, ISummary, IUseActivitiesReturn } from "@/types";
import { useCallback, useState } from "react";
import { Alert } from "react-native";

export const useActivities = (userId: string): IUseActivitiesReturn => {
  ...
  const fetchActivities = useCallback(async () => {
    ...
    try {
      ...
      const result:IActivity[] = await response.json();
  ...
  const fetchSummary = useCallback(async () => {
    ...
    try {
      ...
      const result: ISummary = await response.json();
